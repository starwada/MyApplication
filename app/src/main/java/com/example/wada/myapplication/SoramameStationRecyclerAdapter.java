...
/**
 * Created by Wada on 2016/07/07
 * RecyclerView用に書き直し
 */
public class SoramameStationRecyclerAdapter extends RecyclerView.Adapter<SoramameStationRecyclerAdapter.ViewHolder> {
...
//            sel = (CheckBox) view.findViewById(R.id.select);
    ...
    public SoramameStationRecyclerAdapter(Context context, List<Soramame> objects){
